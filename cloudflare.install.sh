...
if [ "$LOCAL_FILE_PATH" = "" ]; then
    ...
    DOWNLOAD_URL="https://github.com/mmuyskens/CloudFlare-CPanel/archive/v$LATEST_VERSION.tar.gz"
...
ln -s /root/cf_api /root/.cpanel/datastore/cf_api
chattr +i /root/cf_api
